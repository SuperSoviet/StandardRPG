  ...
  public class Player : LivingCreature
    {
        ...
        public static Player CreatePlayerFromDatabase(
            int currentHitPoints, int maximumHitPoints, int gold, int experiencePoints, int currentLocationID)
        {
        ...
        public void MoveTo(Location newLocation)
        {
            ...
            if(newLocation.QuestAvaiblableHere != null)
            {
                ...
                bool playerAlreadyHasQuest = HasThisQuest(newLocation.QuestAvaiblableHere);
                bool playerAlreadyCompletedQuest = CompletedThisQuest(newLocation.QuestAvaiblableHere);
                ...
                if(playerAlreadyHasQuest)
                {
                    ...
                    if(!playerAlreadyCompletedQuest)
                    {
                        ...
                        bool playerHasAllItemsToCompleteQuest = HasAllQuestCompletionItems(newLocation.QuestAvaiblableHere);
                        ...
                        if(playerHasAllItemsToCompleteQuest)
                        {
                            // Display message
                            RaiseMessage("");
                            RaiseMessage("You complete the '" + newLocation.QuestAvaiblableHere.Name + "' quest.");

                            // Remove quest items from inventory
                            RemoveQuestCompletionItems(newLocation.QuestAvaiblableHere);

                            // Give quest rewards
                            RaiseMessage("You receive: ");
                            RaiseMessage(newLocation.QuestAvaiblableHere.RewardExperiencePoints + " experience points");
                            RaiseMessage(newLocation.QuestAvaiblableHere.RewardGold + " gold");
                            RaiseMessage(newLocation.QuestAvaiblableHere.RewardItem.Name, true);

                            AddExperiencePoints(newLocation.QuestAvaiblableHere.RewardExperiencePoints);
                            Gold += newLocation.QuestAvaiblableHere.RewardGold;

                            // Add the reward item to the player's inventory
                            AddItemToInventory(newLocation.QuestAvaiblableHere.RewardItem);

                            // Mark the quest as completed
                            MarkQuestCompleted(newLocation.QuestAvaiblableHere);
                        }
                    }
                }
                else
                {
                    ...
                    RaiseMessage("You receive the " + newLocation.QuestAvaiblableHere.Name + " quest.");
                    RaiseMessage(newLocation.QuestAvaiblableHere.Description);
                    ...
                    Quests.Add(new PlayerQuest(newLocation.QuestAvaiblableHere));
                }
            }
