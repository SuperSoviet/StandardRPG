  ...
  public class Player : LivingCreature {
    ...
    public bool HasAllQuestCompletionItems(Quest quest) {
      ...
      foreach (QuestCompletionItem questcompletionitem in quest.QuestCompletionItems) {
        ...
        if (!Inventory.Any(ii => ii.Details.ID == questcompletionitem.Details.ID && ii.Quantity >= questcompletionitem.Quantity)) {
          return false;
        }
      }
    ...
    private void CheckQuests(Location newLocation) {
      // Does the location have a quest?
      if (newLocation.QuestAvailableHere != null) {
        // See if the player already has the quest, and if they've completed it
        // See if the player already has the quest
        if (HasThisQuest(quest: newLocation.QuestAvailableHere)) {
    ...
    private void GiveQuest(Location newLocation) {
