...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public List<HealingPotion> Potions
        {
            get
            {
                return Inventory.Where(x => x.Details is HealingPotion).Select(x => x.Details as HealingPotion)
                    .ToList();
            }
        }
        ...
        public void RemoveItemFromInventory(Item itemToRemove, int quantity = 1)
        {
            ...
            else
            {
                ...
                // dont allow negative quantities we might want to raise a error for this situation
                if (item.Quantity < 0)
                {
                    item.Quantity = 0;
                }
        ...
        public void RemoveQuestCompletionItems(Quest quest)
        {
            ...
            {
                // subtract the quatity from the player's inventory that was needed to complete the quest
        ...
        public void AddItemToInventory(Item itemToAdd, int quantity = 1)
        {
            ...
            if (item == null)
            {
                // they didn't have the item so add it to their inventory with the quantity of 1 
        ...
        public string ToXmlString()
        {
            ...
            // Create an "InventoryItem" node for each item in the players inventory 
            foreach (InventoryItem item in this.Inventory)
            {
                XmlNode inventoryItem = playerData.CreateElement("InventoryItems");

                XmlAttribute idAdttribute = playerData.CreateAttribute("ID");
                idAdttribute.Value = item.Details.ID.ToString();
                inventoryItem.Attributes.Append(idAdttribute);
            ...
            // create a "PlayerQuest" node for each quest the player has acqiured
